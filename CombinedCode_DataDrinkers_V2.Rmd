---
title: "CompleteCode_airbnb_exploration"
author: "DataDrinker"
date: "12/15/2021"
...
```{r}
#listings_sel$host_is_superhost <- as.numeric(ifelse(listings_sel$host_is_superhost == 'TRUE', 1, 0))
#listings_sel$host_has_profile_pic <- as.numeric(ifelse(listings_sel$host_has_profile_pic == 'TRUE', 1, 0))
#listings_sel$host_identity_verified <- as.numeric(ifelse(listings_sel$host_identity_verified == 'TRUE', 1, 0))
#listings_sel$has_availability <- as.numeric(ifelse(listings_sel$has_availability == 'TRUE', 1, 0))
#listings_sel$instant_bookable <- as.numeric(ifelse(listings_sel$instant_bookable == 'TRUE', 1, 0))
```
...
#mihir exploration
```{r}
Airbnb = read.csv('/Users/apple/Desktop/R_files/data/listings_sel.csv')
